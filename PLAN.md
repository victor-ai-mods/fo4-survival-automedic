...
сейчас — `README.md` (описание по коду).
...
- [ ] Решить, входит ли в первый релиз кола на ОД как самостоятельная нужда. Сейчас её нет
      (`README.md` §12); если нет — так и написать в описании.
...
- [ ] Полная пересборка из исходников (порядок — `README.md` §13): `gen_esp`, `gen_psc`,
...
- **Описание и обложку предоставляет автор.** Из `README.md` для описания пригодятся:
  - §1 — что делает мод;
